         ...
         <?php
            $sql = "SELECT
	          ...
	          while($row = DB_fetch_row($res)) {
                ...
                if ($row[7] === 'Enviado a Revisión') {
                    $style = 'style="background-color: #EBF8A4;"';
                } elseif ($row[7] === 'Calificado') {
                    $style = 'style="background-color: #85D6FF;"'; // color para calificado
                }elseif ($row[7] === 'Recibido'){
                ...
                if ($row[7] === 'Recibido'){
                    echo '<td>
                             <div class="d-flex flex-column gap-2"> 
                                <a href="AP_001_001n.php?A=vRev&ID='.$row[0].'" 
                                ...
                                <a href="AP_001_001n.php?A=vDet&ID='.$row[0].'"
                                    class="btn mt-1"
                                    role="button"
                ...
                else if ($row[7] === 'Enviado a Revisión'){
                ...
                } else if ($row[7] === 'Aprobado' Or  $row[7] === 'Rechazado'){
                    echo '<td> <div class="d-flex flex-column gap-2"> 
                                <a href="AP_001_001n.php?A=vWResul&ID='.$row[0].'" 
                                   class = "btn btn-primary"
                                   role = button>
	          ...
	          } else if ($row[7] === 'Calificado'){
                echo '<td> <div class="d-flex flex-column gap-2"> 
                                <a href="AP_001_001n.php?A=vSResul&ID='.$row[0].'" 
                                   class = "btn btn-primary"
                                   role = button>
                                   <i class="fa-solid fa-user-graduate"></i>
                                   Enviar Resultado
